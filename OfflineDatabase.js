...
var createStatement = "CREATE TABLE IF NOT EXISTS Dictionary (id INTEGER PRIMARY KEY AUTOINCREMENT, word TEXT, example TEXT, signexample TEXT, meaning TEXT)";
 
var selectAllStatement = "SELECT * FROM Dictionary";
 
var insertStatement = "INSERT INTO Dictionary (word, example, signexample, meaning) VALUES (?, ?, ?, ?)";
 
var updateStatement = "UPDATE Dictionary SET word = ?, example = ?, signexample = ?, meaning = ? WHERE id=?";
 ...
 
{
        ...
        db.transaction(function (tx) { tx.executeSql(insertStatement, [wordtemp, exampletemp, signexampletemp, meaningtemp], loadAndReset, onError); });
 ...
 
{
    ...
    db.transaction(function (tx) { tx.executeSql(updateStatement, [wordupdate, exampleupdate, signexampleupdate, meaningupdate, Number(idupdate)], loadAndReset, onError); });
